...
defined(name)('BASEPATH') OR exit('No direc script access allowed');
...
$this->load->view('templates/footer');
	...
	$this->session->set_flashdata('msg', '<div class="alert alert-success text-center">Произошла ошибка, повторите попытку позже</div>');	
	redirect('/contact');
}
