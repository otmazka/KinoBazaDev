        	...
        	$this->email->message($message);
                if ($this->email->send()) {
                      ...
                      $this->session->set_flashdata('msg',
                        '<div class="alert alert-success text0center">Ваше сообщение успешно отправлено!</div>') ;
                         redirect('/contact');
                }else{ 

                   $this->session->set_flashdata('msg',
                        '<div class="alert alert-success text0center">Произошла ошибка,повторите попытку позже!</div>') ;
                         redirect('/contact');
                }
