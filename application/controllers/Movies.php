...
public function view($slug = NULL){
	...
	$this->data['discriptions_movie'] = $movie_slug['discriptions'];
...
$p_config['cur_tag_open'] = "<li class='disabled'><li class='acrive'><a href='#'>";
...
$this->data['pagination'] = this->pegination->create_links();
...
if($this->Films_model->deleteMovies($slug)){
	$this->data['result'] = $this->data['movies_delete']['name']. "успешно удалён";
